...
<section class="blue-gradient-background">
    <div class="chat-app light-grey-blue-background">
        <form id="status_form" action="{{ url('/activities/postStatusUpdate') }}" method="post">
...
<script>
    ...
    function statusUpdateSubmit() {
        ...
        $.post('{{ url("/activities/postStatusUpdate") }}', data).success(statusUpdateSuccess);
    ...
    function sendLike(id) {
        $.post('{{ url("/activities/postLike") }}/' + id).success(likeSuccess);
    }
